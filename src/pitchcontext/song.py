...
class Song:
    ...
    def getColoredSong(self, colordict, lyrics=None):
    ...
    def createColoredPDF(self, colordict, outputpath, filebasename=None, showfilename=True, lyrics=None):
        ...
        s = self.getColoredSong(colordict, lyrics=lyrics)
    ...
    def createColoredPNG(self, colordict, outputpath, filebasename=None, showfilename=True, lyrics=None):
        ...
        """
        pdf_fn = self.createColoredPDF(colordict, outputpath, filebasename, showfilename, lyrics=lyrics)
    ...
    def showColoredPNG(self, colordict, outputpath, filebasename=None, showfilename=True, lyrics=None):
        ...
        showfilename : bool, default True
            Include the filename in the png (lilypond opus header).
        """
        png_fn = self.createColoredPNG(colordict, outputpath, filebasename, showfilename, lyrics=lyrics)
        display.display(display.Image(png_fn))

    def showPNG(self, lyrics=None):
        """Show a png with a score of the song. For use in a Jupyter notebook.
        """
        with tempfile.TemporaryDirectory() as tmpdirname:
            self.showColoredPNG({}, tmpdirname, showfilename=False, lyrics=lyrics)
    
    def createPNG(self, outputpath, filebasename=None, showfilename=False, lyrics=None):
        return self.createColoredPNG({}, outputpath, filebasename=filebasename, showfilename=showfilename, lyrics=lyrics)
